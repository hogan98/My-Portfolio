...
<html lang="en">
    <head>
        ...
        <title>Ian Reeves - Fullstack Web Developer - HTML, CSS, PHP, Javascript</title>
        <meta name="description" content="Text Coming Soon...."/>

          <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css" integrity="sha512-iecdLmaskl7CVkqkXNQ/ZH/XLlvWZOJyj7Yy7tcenmpD1ypASozpmT/E0iPtmFIB46ZmdtAc9eNBvH0H/ZpiBw==" crossorigin="anonymous" referrerpolicy="no-referrer" />
        @vite(['resources/scss/app.scss','resources/css/app.css', 'resources/js/app.js','resources/js/lightmode.js'])
    </head>
   	...
   	<body>
        <header>
            ...
            <nav class="nav-bar">
                <ul>
                    ...
                    <li>
                        <a href="#about" class="nav-link nav-link-ltr">About</a>
                    </li>
                    <li>
                        <a href="#web-portfolio" class="nav-link nav-link-ltr">Web Portfoio</a>
                    </li>
                    <li>
                        <a href="#graphic-portfolio" class="nav-link nav-link-ltr">Graphic Portfolio</a>
                    </li>
                    <li>
                        <a href="#contact" class="nav-link nav-link-ltr">Contact</a>
                    </li>
                </ul>
            </nav>
        </header>
        ...
        <footer class="footer">
             <div class="socials">
                <a target="_BLANK" href="https://www.linkedin.com/in/ian-reeves-3b272b254/">
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="60" viewBox="0 0 48 48">
                        <path fill="#0288D1" d="M42,37c0,2.762-2.238,5-5,5H11c-2.761,0-5-2.238-5-5V11c0-2.762,2.239-5,5-5h26c2.762,0,5,2.238,5,5V37z"></path><path fill="#FFF" d="M12 19H17V36H12zM14.485 17h-.028C12.965 17 12 15.888 12 14.499 12 13.08 12.995 12 14.514 12c1.521 0 2.458 1.08 2.486 2.499C17 15.887 16.035 17 14.485 17zM36 36h-5v-9.099c0-2.198-1.225-3.698-3.192-3.698-1.501 0-2.313 1.012-2.707 1.99C24.957 25.543 25 26.511 25 27v9h-5V19h5v2.616C25.721 20.5 26.85 19 29.738 19c3.578 0 6.261 2.25 6.261 7.274L36 36 36 36z"></path>
                    </svg>
                </a>

                <a target="_BLANK" href="https://github.com/hogan98">
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="60" viewBox="0 0 48 48">
             ...
             <a class="footer-text"> Ian Reeves &copy; {{ date('Y') }}</a>
        </footer>
    </body>
</html>
